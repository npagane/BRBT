...
class Gen_compressed(threading.Thread):
  ...
  def run(self):
    ...
    if ('generators' in self.bundles):
      ...
      #self.gen_generator("php")  REMOVED THIS 06/25 by nicole pagane
      #self.gen_generator("lua")  makes compiling quicker since we're
      #self.gen_generator("dart") not going to develop these languages
