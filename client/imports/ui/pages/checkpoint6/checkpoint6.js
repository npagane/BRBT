import {
  ...
  import './checkpoint6.html';
  
  Template.checkpoint6.onCreated(function created() {
    this.autorun(() => {
      try {
  ...
  //4
    ...
    'click #wrongAnswer4': function () {
      ...
      document.getElementById('postQuestion').innerHTML += '<p><h5> The correct anwer to this question is B: </h5></p>';
      // END SHOW HERE 
      // do not give points
      try {
        var userName = Meteor.users.findOne(Meteor.userId()).username;
